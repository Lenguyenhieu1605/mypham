        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShipPhoneNumber = table.Column<string>(maxLength: 10, nullable: false),
                    Status = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "AppConfigs",
                columns: new[] { "Key", "ConcurrencyStamp", "Id", "Name", "NormalizedName", "Value" },
                values: new object[,]
                {
                    { "HomeTitle", "4a1ae08a-f60f-46a2-accf-da0a3a0afa0b", new Guid("00000000-0000-0000-0000-000000000000"), null, null, "This is home page of ShopHD" },
                    { "HomeKeyword", "9f5f381c-5a00-4d30-a982-a20570e6ac31", new Guid("00000000-0000-0000-0000-000000000000"), null, null, "This is keyword of ShopHD" },
                    { "HomeDescription", "ca472bc5-64c7-476e-b285-54c59b777686", new Guid("00000000-0000-0000-0000-000000000000"), null, null, "This is description of ShopHD" }
                });

            migrationBuilder.InsertData(
                table: "AppRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Description", "Name", "NormalizedName" },
                values: new object[] { new Guid("0471ff08-3e9d-4c2e-9748-9a6252b55eea"), "78618913-2916-4ee9-8959-d93d721050ff", "Administrator role", "admin", "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("46064bfd-a12e-4cb6-8d63-6f0ba81aa70d"), 0, "7d41e8ae-fb80-495d-841b-5a699dd5dc53", new DateTime(1999, 6, 8, 0, 0, 0, 0, DateTimeKind.Unspecified), "diem99spk@gmail.com", true, "Diem", "Vo", false, null, "diemvo99spk@gmail.com", "admin", "AQAAAAEAACcQAAAAEAiSBogUVomdzYJ0Q8WvBT44IbWd9YMfjFBzptJJpDb9/Fm51yRW5dV1bG4ZqUFmjg==", null, false, "", false, "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2020, 12, 1, 1, 32, 29, 396, DateTimeKind.Local).AddTicks(5846), 99000m, 100000m, null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Son 3CE Velvet Tint", "Son 3CE Velvet Tint", "Son 3CE", 1 });
