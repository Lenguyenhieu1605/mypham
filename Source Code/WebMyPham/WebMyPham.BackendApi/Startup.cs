    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                //Định nghĩa SecurityDefinition
                //Mô tả mỗi khi gọi Swagger có header là "Bearer" và Name là "Authorization", header có type là APIkey
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Swagger WebMyPham V1"); //đường dẫn chứa danh sách mô tả của api
            });
